...
Pool operator has to register the pool with a value that is equal or more than the required minimum self-bonded stake (1000 AION) of an ADS pool, otherwise the registration will be rejected.
