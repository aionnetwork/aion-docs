...
excerpt: "Add `AION` into your custom wallet."
---
...
[block:callout]
{
  "type": "warning",
  "title": "Note",
  "body": "Code samples provided in this guide are not production ready, they are designed to guide you through the steps but the implementation of these functionalities should be up to you and your set up."
}
[/block]
...
[/block]
To set up a node please refer to [Aion Node Setup Guide](https://docs.aion.network/docs/node-setup)

For more options:

1. [Blockdaemon](https://app.blockdaemon.com/dashboard) one of our partners for node hosting(often used for testing)
2. [Nodesmith](https://nodesmith.io/) have hosted Aion nodes that are available for free.
...
[block:callout]
{
  "type": "warning",
  "title": "Note",
  "body": "Derivation path for 3rd-party wallets might vary depending on their implementation. In that case only the root account (first account) will be the same, every next account after that will depend on the last 3 digit sections in the derivation path (0'/0'/0')."
}
[/block]
...
[/block]
##Python
The above functionalities can also be conducted in Python. Click [here](https://github.com/LedgerHQ/ledger-app-aion/tree/master/test/python-testcases) for more information.
...
[/block]
### [Migrating from Ethereum](https://docs.aion.network/docs/migrating-smart-contracts-from-ethereum)

### [ATS Contract (ERC-777 with Crosschain hooks)](https://github.com/aionnetwork/AIP/blob/master/AIP-004/AIP%23004.md)