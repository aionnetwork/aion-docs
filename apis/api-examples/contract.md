...
1. [Retrieve Available Compilers](#retrieve-available-compilers)
2. [Compile Solidity Code](#compile-solidity-code)
3. [Retrieve Energy Price](#retrieve-energy-price)
4. [Estimate Energy Required](#estimate-energy-required)
5. [Retrieve Contract Code](#retrieve-contract-code)
6. [Retrieve Stored Value](#retrieve-stored-value)
7. [Deploy Contract](#deploy-contract)
8. [Execute Contract Function](#execute-contract-function)
9. [Call Contract Function](#call-contract-function)
