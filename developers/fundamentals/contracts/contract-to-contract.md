...
Then, you must create an ABIDecoder object and use [`Result.getReturnData()`](https://avm-api.aion.network/avm/result)  to get the data returned by the invoked call. See [AVM ABIDecoder](fundamentals-packages-abi-#section-abistreamingencoder) section for more details.
