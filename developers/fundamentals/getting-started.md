...
Follow through the [IntelliJ end-to-end](tools-intellij-plugin-end-to-end-), or [Maven CLI end-to-end](tools-maven-cli-end-to-end-).
...
Review the [end-to-end testing guide](basics-test-and-debug-end-to-end-) to get a solid understanding of how to run tests within IntelliJ.
...
The [Fundamentals](fundamentals-) section walks through these points. Things like `@Callable` and `@Fallback` annotations are incredibly valuable when creating a dApp. It's a good idea to get a solid understanding of the packages section under fundamentals.
