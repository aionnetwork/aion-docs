...
You can initialize contract variables by passing in arguments while you deploy your smart contract. To do that, you can use either `@Initializable fields` (in the first tab) or an [**ABIDecoder**](fundamentals-aion-packages-abi-#section-abidecoder) to collect the data (in the second tab).
