---
title: Log
description: A log is used to store arguments and data in a transaction receipt on the blockchain. Within the Aion Virtual Machine, a log can have 0 to 4 topics and at least one data field.
table_of_contents: true
---

You can view further documentation into [Blockchain.require()](https://avm-api.aion.network/avm/blockchain#section-section-log%28byte%5B%5D%29) on the [AVM API website](https://avm-api.aion.network/).
