...
The [Landing Page](https://mainnet.aion.network/) is the home of the Aion Dashboard. It provides the current view of recent blocks and transactions on the network, as well as some current statistics. You can reach this page at any time by clicking the Aion logo on the top left.
...
Details pages contain information on the objects on the network. You can find these pages through the [**Search Function**](/developers/tools/dashboard/usingSearchFunction) or by clicking on any of the hex addresses on the site.
